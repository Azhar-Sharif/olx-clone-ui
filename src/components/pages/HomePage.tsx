...
export const HomePage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-100 via-blue-400 to-cyan-400 flex flex-col">
          ...
          {isAuthenticated && user ? (
            ...
            <>
              <p className="text-gray-700 text-lg leading-relaxed font-medium">
                Start your journey by creating an account or signing in to
